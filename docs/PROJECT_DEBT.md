...
| ID | Status | Owner | Acceptance gate | Evidence |
|---|---|---|---|---|
| D-01 | complete | FDE#15 | repository-local WFO handoff exists | `docs/WEBFACTORYOS.md` |
| D-02 | complete | FDE#15 | README tree matches committed paths | `README.md` |
| D-03 | complete | FDE#15 | one local validation entry point | `scripts/validate_repository.py` |
| D-04 | complete | FDE#15 | repository contract extends fixture validation | `docs/VALIDATION.md` |
